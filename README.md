...
# Optiwing SEO Tool: 
Full Stack SaaS Web Application that identifies clusters of related search terms for digital marketers and SEO professionals. Developed with Next.js and uses Google SERP API and OpenAI GPT-4 for keyword generation. Stores keyword groups in non-relational database and serves them from Node.js/Express.js server in the cloud. Bootstrapped SaaS.
