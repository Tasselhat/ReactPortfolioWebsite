                    ...
                    <div className="content-wrapper">
                        <div className="content-container">
                            <div className="grid-thumbs">
                                    ...
                                    {this.state.isHovering &&
                                        projectHoverID === 1 && (
                                            <div className="on-hover-info">
                                                <h2>
                                                    Full stack web app, budget
                                                    tracker connected to mongoDB
                                                    with registration to save
                                                    budgets. Allows users to
                                                    enter monthly expenses,
                                                    savings, and investments.
                                                    With reccomendations for
                                                    saving and investing, users
                                                    enter monthly income and the
                                                    app will return charts with
                                                    exact amounts for for
                                                    expenses, discretionary
                                                    spending, and saving, as
                                                    well as a compound interest
                                                    calculator to help users
                                    ...
                                    {this.state.isHovering &&
                                        projectHoverID === 2 && (
                                            <div className="on-hover-info">
                                                <h2>
                                                    Sorting alogrithms
                                                    vizualizer made with React
                                                    and vanilla Javascript,
                                                    vizualizer for bubble sort,
                                ...
                                <a
                                    href="https://shastagymnastics.netlify.app/"
                                    className="grid-item"
                                >
                                    <div className="preview-img">
                                        {this.state.isHovering &&
